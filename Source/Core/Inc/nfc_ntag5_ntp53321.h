...
#define NFC_SRAM_CMD_BLOCK              0x0020U
#define NFC_SRAM_CHALLENGE_BLOCK_START  0x0021U
#define NFC_SRAM_CHALLENGE_BLOCK_END    0x0024U
#define NFC_SRAM_RESPONSE_BLOCK_START   0x0025U
#define NFC_SRAM_RESPONSE_BLOCK_END     0x0028U
#define NFC_SRAM_STATUS_BLOCK           0x0029U

/* User CMD SRAM layout (Layer2) */
#define NFC_SRAM_UCMD_HEADER_BLOCK      0x0030U
#define NFC_SRAM_UCMD_DATA_BLOCK_START  0x0031U
#define NFC_SRAM_UCMD_DATA_BLOCK_END    0x0034U
#define NFC_SRAM_UCMD_RESULT_BLOCK_START 0x0035U
