...
#define APP_FW_VERSION_MINOR                        (9u)
...
//NBIoT simulation code
#undef NBIoT_SIMULATION_CODE
...
#define APP_SELFTEST_UART_METER_LOOP_EXPECTED_RX_MIN_LEN (5u)
...
#define APP_SELFTEST_UART_METER_POST_CFUN_FAIL_SETTLE_DELAY_MS   (2500u)
...
#define APP_POLICY_DEFAULT_MANAGEMENT_REPORTING_PERIOD_HOURS  (1u)
...
#define APP_POLICY_SERVER_ACK_TIMEOUT_MS           (10000u)
#define APP_POLICY_SERVER_ACK_POLL_MS              (500u)
#define APP_POLICY_SERVER_ACK_READ_BYTES           (64u)
#define APP_POLICY_DEFAULT_SERVER_ACK_TIMEOUT_SEC  (APP_POLICY_SERVER_ACK_TIMEOUT_MS / 1000u)
