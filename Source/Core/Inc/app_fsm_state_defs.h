...
typedef enum {
    ...
    APP_FSM_STATE_RTC_READY,
    APP_FSM_STATE_LPTIM_INIT,
    APP_FSM_STATE_LPTIM_WAKE_SERVICE,
    APP_FSM_STATE_LPTIM_APPLY_SYNC,
    APP_FSM_STATE_LPTIM_READY,
    APP_FSM_STATE_WATCHDOG_INIT,
    APP_FSM_STATE_WATCHDOG_FEED,
    APP_FSM_STATE_WATCHDOG_RELEASE,
    APP_FSM_STATE_STORAGE_INIT,
    APP_FSM_STATE_STORAGE_SERVICE,
    APP_FSM_STATE_STORAGE_RELEASE,
    APP_FSM_STATE_FAULT,
    MAX_APP_FSM_STATE
}APP_FSM_STATE_t;
