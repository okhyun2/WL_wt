...
#define NFC_CMD_IND_REQ_BLOCK_LEN       ((uint8_t)(NFC_SRAM_UCMD_PAYLOAD_BLOCK_END - NFC_SRAM_UCMD_CMD_BLOCK + 1U))
#define NFC_CMD_IND_RSP_ADDR            ((uint8_t)(NFC_SRAM_UCMD_CMD_BLOCK & 0xFFU))
#define NFC_CMD_IND_RSP_BLOCK_LEN       ((uint8_t)(NFC_SRAM_UCMD_PAYLOAD_BLOCK_END - NFC_SRAM_UCMD_CMD_BLOCK + 1U))
