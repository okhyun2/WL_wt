...
/* Private defines -----------------------------------------------------------*/
#define NBIoT_EN_Pin GPIO_PIN_13
#define NBIoT_EN_GPIO_Port GPIOC
#define NBIoT_RI_Pin GPIO_PIN_0
#define NBIoT_RI_GPIO_Port GPIOH
#define ESI_Int_Pin GPIO_PIN_2
#define ESI_Int_GPIO_Port GPIOC
...
#define REED_IN_GPIO_Port GPIOB
#define WD_FEED_Pin GPIO_PIN_7
#define WD_FEED_GPIO_Port GPIOC
